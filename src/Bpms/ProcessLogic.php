...
use Bpms\Data\DataRepositoryInterface;
use Carbon\Carbon;
...
class ProcessLogic implements ProcessLogicInterface
{
    ...
    public function createProcess($title, $wid, $userId, $type = null, $newType = null, $wbody = null, $wsvg = null, $opts = null)
    {
        //$typeId = $type ? $type : $this -> dataRepo -> findEntity(DataRepositoryInterface::TABLE_PROCESS_TYPE, ['name' => $newType, 'user_id' => $userId]) -> id;
        if ($type) {
            $typeId = $type;
        } elseif ($newType) {
        ...
        return $this->dataRepo->createEntity(DataRepositoryInterface::TABLE_PROCESS, [
            ...
            'wsvg' => $wsvg ? $wsvg : null,
            'options' => $opts,
            'wbody' => $wbody ? $wbody : '<?xml version="1.0" encoding="UTF-8"?>
    ...
    public function updateProcess($predicate, $data, $create = false)
    {
    ...
    {
        return $this->dataRepo->findEntities(DataRepositoryInterface::TABLE_PROCESS, $predicate);
    }
